...
public class welcome_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button addGame = view.findViewById(R.id.add_Game);
        addGame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //navigate to user_add_games fragment
                Navigation.findNavController(view).navigate(R.id.action_welcome_fragment_to_user_add_games);

            }
        });

        Button findGames = view.findViewById(R.id.find_Games);
        findGames.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //navigate to find_games fragment
                Navigation.findNavController(view).navigate(R.id.action_welcome_fragment_to_find_games);
